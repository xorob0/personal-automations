...
['personal_gaby']: {
  entity_id: "calendar.personal_gaby",
get entity() { return {state: shadowState["calendar.personal_gaby"].state, attributes: shadowState["calendar.personal_gaby"].attributes} as CalendarProperties}
},
