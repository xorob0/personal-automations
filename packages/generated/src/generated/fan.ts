...
get entity() { return {state: FanStateMapper[shadowState["fan.afzuiging_badkamer"].state as string], attributes: shadowState["fan.afzuiging_badkamer"].attributes} as FanProperties},
