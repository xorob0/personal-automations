...
export type LockIDs = "washing_machine_plug_child_lock" | "desk_outlet_child_lock" | "bedroom_humidifier_switch_child_lock" | "bedside_lamp_child_lock" | "bedroom_secondary_lamp_child_lock" | "christmas_tree_led_outlet_child_lock" | "wallbox_portal_locked_unlocked"
...
lock() { return callService("lock", "lock", {}, {entity_id: "lock.washing_machine_plug_child_lock"})},
unlock() { return callService("lock", "unlock", {}, {entity_id: "lock.washing_machine_plug_child_lock"})},
open() { return callService("lock", "open", {}, {entity_id: "lock.washing_machine_plug_child_lock"})}
},
