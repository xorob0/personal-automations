...
['plex_frederic_plex_for_android_mobile_galaxy_s22']: {
  entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22",
get entity() { return {state: shadowState["media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"].state, attributes: shadowState["media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"].attributes} as MediaPlayerProperties},
turnOn() { return callService("media_player", "turn_on", {}, {entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"})},
turnOff() { return callService("media_player", "turn_off", {}, {entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"})},
playMedia(media:Media) { return callService("media_player", "play_media", media, {entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"})},
selectSource(source:string) { return callService("media_player", "select_sound", {source}, {entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"})},
selectSoundMode(sound_mode:string) { return callService("media_player", "select_sound_mode", {}, {entity_id: "media_player.plex_frederic_plex_for_android_mobile_galaxy_s22"})}
},

['plex_frederic_plex_cast_chromecast']: {
  entity_id: "media_player.plex_frederic_plex_cast_chromecast",
get entity() { return {state: shadowState["media_player.plex_frederic_plex_cast_chromecast"].state, attributes: shadowState["media_player.plex_frederic_plex_cast_chromecast"].attributes} as MediaPlayerProperties},
turnOn() { return callService("media_player", "turn_on", {}, {entity_id: "media_player.plex_frederic_plex_cast_chromecast"})},
turnOff() { return callService("media_player", "turn_off", {}, {entity_id: "media_player.plex_frederic_plex_cast_chromecast"})},
playMedia(media:Media) { return callService("media_player", "play_media", media, {entity_id: "media_player.plex_frederic_plex_cast_chromecast"})},
selectSource(source:string) { return callService("media_player", "select_sound", {source}, {entity_id: "media_player.plex_frederic_plex_cast_chromecast"})},
selectSoundMode(sound_mode:string) { return callService("media_player", "select_sound_mode", {}, {entity_id: "media_player.plex_frederic_plex_cast_chromecast"})}
},

['plex_kapy_plex_for_mac_tims_macbook_pro_local']: {
  entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local",
get entity() { return {state: shadowState["media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"].state, attributes: shadowState["media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"].attributes} as MediaPlayerProperties},
turnOn() { return callService("media_player", "turn_on", {}, {entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"})},
turnOff() { return callService("media_player", "turn_off", {}, {entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"})},
playMedia(media:Media) { return callService("media_player", "play_media", media, {entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"})},
selectSource(source:string) { return callService("media_player", "select_sound", {source}, {entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"})},
selectSoundMode(sound_mode:string) { return callService("media_player", "select_sound_mode", {}, {entity_id: "media_player.plex_kapy_plex_for_mac_tims_macbook_pro_local"})}
},

['plex_flo_g94_plex_for_android_mobile_galaxy_s22']: {
  entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22",
get entity() { return {state: shadowState["media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"].state, attributes: shadowState["media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"].attributes} as MediaPlayerProperties},
turnOn() { return callService("media_player", "turn_on", {}, {entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"})},
turnOff() { return callService("media_player", "turn_off", {}, {entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"})},
playMedia(media:Media) { return callService("media_player", "play_media", media, {entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"})},
selectSource(source:string) { return callService("media_player", "select_sound", {source}, {entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"})},
selectSoundMode(sound_mode:string) { return callService("media_player", "select_sound_mode", {}, {entity_id: "media_player.plex_flo_g94_plex_for_android_mobile_galaxy_s22"})}
},
