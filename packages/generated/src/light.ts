import {callService, shadowState, Light} from "@herja/core"
    export type LightIDs = "bedside_lamp" | "garden" | "bedroom_secondary_lamp" | "bedroom_lights" | "bedroom_secondary_lights" | "living_room_spot_3" | "living_room_spot_2" | "dining_room_spot_3" | "kitchen_spot_1" | "living_room_light" | "dining_room_spot_2" | "dining_room_spot_1" | "kitchen_spot_2" | "bedroom_bed_light" | "bathroom_spot_2" | "hall_upstairs_spot_3" | "hall_upstairs_spot_2" | "hall_upstairs_spot_1" | "toilet" | "garage_fridge" | "hall_entrance" | "garage_car" | "kitchen_spot_3" | "living_room_spot_1" | "hall_stairs" | "bathroom_spot_1" | "0x001788010b21a974" | "kitchen_spots" | "living_room_spots" | "dining_room_spots" | "living_room_all" | "hall" | "hall_upstairs" | "garage" | "bathroom" | "living_room_tripod" | "b8030a1c_3ebf007c" | "ebbff7dd_e82b404f" | "aadf3129_ecd1ece2" | "dc3b1fc5_4961a7e0" | "8ef2ec82_947cc02d" | "da2cf25e_bb796133" | "ccbd4341_01cc53c2" | "00e9e4f0_03e3732b" | "2bd1a2c0_2263df99" | "fde49bad_fb722687" | "7999b6c0_f93fbc37" | "50a79e21_74701770" | "187a9779_66735846" | "a788d83b_085169a8" | "21adb4aa_66a6b9a2" | "3f2bb951_563ca5f2" | "1022b84e_7cd988a8" | "feacdc57_b8eef177" | "f262e3a5_84b84bbf" | "d2e7a315_c989724f" | "b7b40ca4_91628aa2"
...
["0x001788010b21a974"]: {
entity_id: "light.0x001788010b21a974",
turn_on: (serviceData = {}) => callService("light", 'turn_on', serviceData, {entity_id: "light.0x001788010b21a974"}),
turn_off: (serviceData = {}) => callService("light", 'turn_off', serviceData, {entity_id: "light.0x001788010b21a974"}),
isOn: () => shadowState["light.0x001788010b21a974"].state === "on",
toggle: (serviceData = {}) => callService("light", 'toggle', serviceData, {entity_id: "light.0x001788010b21a974"}),
get state() { return shadowState["light.0x001788010b21a974"]},
},
...
["d2e7a315_c989724f"]: {
entity_id: "light.d2e7a315_c989724f",
turn_on: (serviceData = {}) => callService("light", 'turn_on', serviceData, {entity_id: "light.d2e7a315_c989724f"}),
turn_off: (serviceData = {}) => callService("light", 'turn_off', serviceData, {entity_id: "light.d2e7a315_c989724f"}),
isOn: () => shadowState["light.d2e7a315_c989724f"].state === "on",
toggle: (serviceData = {}) => callService("light", 'toggle', serviceData, {entity_id: "light.d2e7a315_c989724f"}),
get state() { return shadowState["light.d2e7a315_c989724f"]},
},

["b7b40ca4_91628aa2"]: {
entity_id: "light.b7b40ca4_91628aa2",
turn_on: (serviceData = {}) => callService("light", 'turn_on', serviceData, {entity_id: "light.b7b40ca4_91628aa2"}),
turn_off: (serviceData = {}) => callService("light", 'turn_off', serviceData, {entity_id: "light.b7b40ca4_91628aa2"}),
isOn: () => shadowState["light.b7b40ca4_91628aa2"].state === "on",
toggle: (serviceData = {}) => callService("light", 'toggle', serviceData, {entity_id: "light.b7b40ca4_91628aa2"}),
get state() { return shadowState["light.b7b40ca4_91628aa2"]},
},
}
