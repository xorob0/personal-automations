import {callService, shadowState, Light} from "@herja/core"
    export type LightIDs = "bedside_lamp" | "garden" | "bedroom_secondary_lamp" | "bedroom_lights" | "bedroom_secondary_lights" | "living_room_tripod" | "living_room_spot_3" | "living_room_spot_2" | "dining_room_spot_3" | "kitchen_spot_1" | "living_room_light" | "dining_room_spot_2" | "dining_room_spot_1" | "kitchen_spot_2" | "bedroom_bed_light" | "bathroom_spot_2" | "hall_upstairs_spot_3" | "hall_upstairs_spot_2" | "hall_upstairs_spot_1" | "toilet" | "garage_fridge" | "hall_entrance" | "garage_car" | "kitchen_spot_3" | "living_room_spot_1" | "hall_stairs" | "bathroom_spot_1" | "0x14b457fffefafbcf" | "0xb4e3f9fffe77c636" | "0xb4e3f9fffebc2a4e" | "kitchen_spots" | "living_room_spots" | "dining_room_spots" | "living_room_all" | "hall" | "hall_upstairs" | "garage" | "bathroom"
...
["0x14b457fffefafbcf"]: {
entity_id: "light.0x14b457fffefafbcf",
turn_on: (serviceData = {}) => callService("light", 'turn_on', serviceData, {entity_id: "light.0x14b457fffefafbcf"}),
turn_off: (serviceData = {}) => callService("light", 'turn_off', serviceData, {entity_id: "light.0x14b457fffefafbcf"}),
isOn: () => shadowState["light.0x14b457fffefafbcf"].state === "on",
toggle: (serviceData = {}) => callService("light", 'toggle', serviceData, {entity_id: "light.0x14b457fffefafbcf"}),
get state() { return shadowState["light.0x14b457fffefafbcf"]},
},
