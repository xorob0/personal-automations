...
export const sensor: Sensor<SensorIDs> = {
  ...
  ["sn_3004169620_current_total"]: {
    ...
    get state() { return shadowState["sensor.sn_3004169620_current_total"]},
  },
  ...
  ["sn_3004169620_inverter_power_limit"]: {
    ...
    get state() { return shadowState["sensor.sn_3004169620_inverter_power_limit"]},
  },
  ...
  ["0x0017880109bde997_power"]: {
    ...
    get state() { return shadowState["sensor.0x0017880109bde997_power"]},
  },
  ...
  ["0x0017880109bde997_energy"]: {
    ...
    get state() { return shadowState["sensor.0x0017880109bde997_energy"]},
  },
  ...
  ["tims_iphone_storage"]: {
    ...
    get state() { return shadowState["sensor.tims_iphone_storage"]},
  },

  ["tims_iphone_battery_level"]: {
    entity_id: "sensor.tims_iphone_battery_level",
    get state() { return shadowState["sensor.tims_iphone_battery_level"]},
  },

  ["tims_iphone_battery_state"]: {
    entity_id: "sensor.tims_iphone_battery_state",
    get state() { return shadowState["sensor.tims_iphone_battery_state"]},
  },

  ["tims_iphone_sim_2"]: {
    entity_id: "sensor.tims_iphone_sim_2",
    get state() { return shadowState["sensor.tims_iphone_sim_2"]},
  },

  ["tims_iphone_last_update_trigger"]: {
    entity_id: "sensor.tims_iphone_last_update_trigger",
    get state() { return shadowState["sensor.tims_iphone_last_update_trigger"]},
  },

  ["tims_iphone_ssid"]: {
    entity_id: "sensor.tims_iphone_ssid",
    get state() { return shadowState["sensor.tims_iphone_ssid"]},
  },

  ["tims_iphone_connection_type"]: {
    entity_id: "sensor.tims_iphone_connection_type",
    get state() { return shadowState["sensor.tims_iphone_connection_type"]},
  },

  ["tims_iphone_sim_1"]: {
    entity_id: "sensor.tims_iphone_sim_1",
    get state() { return shadowState["sensor.tims_iphone_sim_1"]},
  },

  ["tims_iphone_geocoded_location"]: {
    entity_id: "sensor.tims_iphone_geocoded_location",
    get state() { return shadowState["sensor.tims_iphone_geocoded_location"]},
  },

  ["tims_iphone_bssid"]: {
    entity_id: "sensor.tims_iphone_bssid",
    get state() { return shadowState["sensor.tims_iphone_bssid"]},
  },

  ["tims_iphone_activity"]: {
    entity_id: "sensor.tims_iphone_activity",
    get state() { return shadowState["sensor.tims_iphone_activity"]},
  },

  ["tims_iphone_distance"]: {
    entity_id: "sensor.tims_iphone_distance",
    get state() { return shadowState["sensor.tims_iphone_distance"]},
  },

  ["tims_iphone_floors_ascended"]: {
    entity_id: "sensor.tims_iphone_floors_ascended",
    get state() { return shadowState["sensor.tims_iphone_floors_ascended"]},
  },

  ["tims_iphone_average_active_pace"]: {
    entity_id: "sensor.tims_iphone_average_active_pace",
    get state() { return shadowState["sensor.tims_iphone_average_active_pace"]},
  },

  ["tims_iphone_floors_descended"]: {
    entity_id: "sensor.tims_iphone_floors_descended",
    get state() { return shadowState["sensor.tims_iphone_floors_descended"]},
  },

  ["tims_iphone_steps"]: {
    entity_id: "sensor.tims_iphone_steps",
    get state() { return shadowState["sensor.tims_iphone_steps"]},
  },
  ...
  ["tim_s_id_4_health_inspection"]: {
    ...
    get state() { return shadowState["sensor.tim_s_id_4_health_inspection"]},
  },
  ...
  ["01073d14_3789_4814_82fe_330131debcf9_100_1_estimated_distance"]: {
    ...
    get state() { return shadowState["sensor.01073d14_3789_4814_82fe_330131debcf9_100_1_estimated_distance"]},
  },
  ...
  ["747addc7_9fb4_43c1_ba7f_41c38118048f_100_1_estimated_distance"]: {
    ...
    get state() { return shadowState["sensor.747addc7_9fb4_43c1_ba7f_41c38118048f_100_1_estimated_distance"]},
  },
  ...
  ["e20a39f4_73f5_4bc4_1864_17d1ad07a962_17667_14594_8ed9_estimated_distance"]: {
    ...
    get state() { return shadowState["sensor.e20a39f4_73f5_4bc4_1864_17d1ad07a962_17667_14594_8ed9_estimated_distance"]},
  },

  ["sb0c958382bb2fbd7c_4623_estimated_distance"]: {
    entity_id: "sensor.sb0c958382bb2fbd7c_4623_estimated_distance",
    get state() { return shadowState["sensor.sb0c958382bb2fbd7c_4623_estimated_distance"]},
  },
  ...
  ["e2c56db5_dffb_48d2_b060_d0f5a71096e0_0_0_estimated_distance"]: {
    ...
    get state() { return shadowState["sensor.e2c56db5_dffb_48d2_b060_d0f5a71096e0_0_0_estimated_distance"]},
  },

  ["accma99c32488a978558_fb1f_estimated_distance"]: {
    entity_id: "sensor.accma99c32488a978558_fb1f_estimated_distance",
    get state() { return shadowState["sensor.accma99c32488a978558_fb1f_estimated_distance"]},
  },
  ...
  ["office_desk_button_click"]: {
    ...
    get state() { return shadowState["sensor.office_desk_button_click"]},
  },

  ["office_desk_button_power_outage_count"]: {
    entity_id: "sensor.office_desk_button_power_outage_count",
    get state() { return shadowState["sensor.office_desk_button_power_outage_count"]},
  },

  ["office_desk_button_device_temperature"]: {
    entity_id: "sensor.office_desk_button_device_temperature",
    get state() { return shadowState["sensor.office_desk_button_device_temperature"]},
  },

  ["office_desk_button_action"]: {
    entity_id: "sensor.office_desk_button_action",
    get state() { return shadowState["sensor.office_desk_button_action"]},
  },

  ["office_desk_button_battery"]: {
    entity_id: "sensor.office_desk_button_battery",
    get state() { return shadowState["sensor.office_desk_button_battery"]},
  },
}
