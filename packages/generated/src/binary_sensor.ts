...
export const binary_sensor: BinarySensor<BinarySensorIDs> = {
  ...
  ["0x540f57fffe68302f_update_available"]: {
    entity_id: "binary_sensor.0x540f57fffe68302f_update_available",
    isOn: () => shadowState["binary_sensor.0x540f57fffe68302f_update_available"].state === "on",
    get state() { return shadowState["binary_sensor.0x540f57fffe68302f_update_available"]},
  },
  ...
  ["desk_update_available"]: {
    entity_id: "binary_sensor.desk_update_available",
    isOn: () => shadowState["binary_sensor.desk_update_available"].state === "on",
    get state() { return shadowState["binary_sensor.desk_update_available"]},
  },
