...
export const binary_sensor: BinarySensor<BinarySensorIDs> = {
  ...
  ["0x001788010b21a974_update_available"]: {
    entity_id: "binary_sensor.0x001788010b21a974_update_available",
    isOn: () => shadowState["binary_sensor.0x001788010b21a974_update_available"].state === "on",
    get state() { return shadowState["binary_sensor.0x001788010b21a974_update_available"]},
  },
